...
| 类别 | 技术选型 |
|------|----------|
| 前端 | Vue 3 (Composition API) + Element Plus + Pinia + Axios + G6 |
| 后端 | FastAPI (Python 3.10+) + Pydantic + SQLAlchemy + Alembic + JWT |
| AI 对接 | LangChain / OpenAI SDK / Anthropic SDK |
...
---
## 📞 联系方式
- 项目主页：[GitHub Repository](https://github.com/your-username/kg-platform)
- 问题反馈：[GitHub Issues](https://github.com/your-username/kg-platform/issues)
- 最后更新时间：2026-06-29
```
